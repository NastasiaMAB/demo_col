...
# Show packages in mylib, the list of packages set to be loaded
sort(mylib)

# If microeco package is needed run line 20 to load it. Otherwise do not load it as it is a BIG package.
# library(microeco)
